export default function undoable(reducer) {
    ...
    return function (state = initialState, action) {
        return doableSwitch(state, action, action.type); //helper function to prevent undo/redo when at start/end of history (several other ways to implement, this way minimizes returns in switch cases)
    }
}